                    ...
                    <div className="menu_section">
                        <ul className="nav side-menu">
                            <li className={(pathCurrent[1] === 'profile' ? "current-page" : "")}>
                                {/* <a href="profile.html"><i className="fa fa-user"></i> Profile</a> */}
                                <a>
                                    <Link to="/profile">
                        ...
                        <ul className="nav side-menu">
                            <li className={(pathCurrent[1] === 'index' ? "current-page" : "")}>
                                {/* <a href=""><i className="fa fa-book"></i> Explore</a> */}
                                <a>
                                    <Link to="/index">
                            ...
                            <li onClick={() => this.setState({ condition: !condition })} className={this.state.condition ? "active" : ""}>
                                ...
                                <ul className="nav child_menu" style={{ display: this.state.condition ? 'block' : 'none' }}>
                                    <li><a href="manageUser.html">User</a></li>
                                    <li><a href="manageBook.html">Book</a></li>
                                    <li><a href="manageDonation.html">Donation Management</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
